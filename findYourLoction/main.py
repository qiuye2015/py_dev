...
class Location(object):
    ...
    def __init__(self, image_path):
        ...
        self.api_key = "55b54a253e44cb832cbc792dc5c7721a0000"
    ...
    def __get_image_ability(self):
        ...
        if img_exif:
            ...
            print("latitude_gps",latitude_gps)
            print("longitude_gps",longitude_gps)
            print("latitude_direction",latitude_direction)
            print("longitude_direction",longitude_direction)
