...
class HouseTradeStatDBManager(DBManager):
    ...
    def init_database(self):
        if not self.table_exist(self._house_trade_data):
    ...
    def save_trade_data(self, data):
        ...
        if self.query_result_exist(exist_sql, exist_params):
        ...
        params = (
            ...
            data["title"],
            data["trade_date"],
            data["online_sign_count"],
            data["online_sign_area"],
            data["house_sign_count"],
            data["house_sign_area"],
            ts,
        )
